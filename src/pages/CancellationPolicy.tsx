        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <div className="bg-white rounded-lg shadow-lg p-8 border-l-4 border-l-qb-green">
              ...
              <p className="text-sm text-gray-500 mb-6">Last Updated: August 08, 2025</p>

              <p className="mb-6 text-qb-dark-gray text-lg">
                At QuantBasket, we aim to provide clear, transparent, and fair terms for all our users. Because our products involve digital assets, tokenized portfolios, and community-based projects, transactions are processed in real time and recorded on the blockchain. This makes reversal or cancellation technically and legally complex.
              </p>
              ...
              <div className="my-6 p-4 bg-gray-50 rounded-lg border border-gray-200 text-base">
                  <p className="text-qb-dark-gray">
                    <strong>Service Delivery:</strong> As a SaaS platform, our services are delivered digitally and are accessible immediately in your account upon successful payment.
                  </p>
              ...
              <p className="mb-4 text-qb-dark-gray">
                <strong>After Purchase:</strong> Once your purchase is confirmed and tokens or access rights are issued, cancellations are not possible due to the irreversible nature of blockchain transactions.
              </p>
              <p className="mb-4 text-qb-dark-gray">
              ...
              <h2 className="text-3xl font-semibold mb-4 text-qb-navy">2. Refunds</h2>
               <ul className="list-disc pl-6 mb-6 text-qb-dark-gray space-y-2">
                <li><strong>Non-Refundable Items:</strong> All purchases of tokens, digital assets, and portfolio products are final and non-refundable once delivered.</li>
                <li><strong>Service Subscriptions:</strong> Monthly/annual service subscriptions can be refunded on a pro-rata basis if cancelled within the first 7 days of the billing cycle.</li>
                <li><strong>Technical Errors:</strong> If a transaction fails due to a verified technical issue on our side and no tokens/assets are delivered, we will issue a full refund in the original payment method.</li>
              ...
              <ul className="list-disc pl-6 mb-6 text-qb-dark-gray space-y-2">
                <li>Blockchain network fees, gas fees, and third-party payment gateway charges are non-refundable.</li>
